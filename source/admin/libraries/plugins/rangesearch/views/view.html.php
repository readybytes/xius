...
class RangesearchView extends XiusBaseView 
{
	...
	function searchHtml($calleObject)
	{
		 ...
		 */
		$fieldHtml ='<input class="inputbox" type="text" name="'.$calleObject->get('pluginType').$calleObject->get('key').'_min" id="'.$calleObject->get('pluginType').$calleObject->get('key').'_min" value="" />';
		$fieldHtml .='<input class="inputbox" type="text" name="'.$calleObject->get('pluginType').$calleObject->get('key').'_max" id="'.$calleObject->get('pluginType').$calleObject->get('key').'_max" value="" />';			
