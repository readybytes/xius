	...
	function testAddSearchToQuery()
	{
		...
		$compare	= "SELECTROUND((3959*acos(cos(0.44237553298691)
						...
						*sin(radians(`proximity_google_latitude_0`))))*1,3)
						ASxius_proximity_distanceWHEREROUND((3959*acos(cos(0.44237553298691)
						*cos(radians(`proximity_google_latitude_0`))
						*cos(radians(`proximity_google_longitude_0`)
						-(1.3026506251295))+sin(0.44237553298691)
		...
		$compare	= "SELECTROUND((3959*acos(cos(0.42296309092831)
					  ...
					  *sin(radians(`proximity_google_latitude_0`))))*1,3)
					  ASxius_proximity_distanceWHEREROUND((3959*acos(cos(0.42296309092831)
		...
		$strQuery 	= $query->__toString();
		$compare	= "SELECTROUND((3959*acos(cos(0.42296309092831)*cos(radians(`proximity_google_latitude_0`))
						*cos(radians(`proximity_google_longitude_0`)-(1.3011255040693))
						+sin(0.42296309092831)*sin(radians(`proximity_google_latitude_0`))))*1,3)
						ASxius_proximity_distance,ROUND((3959*acos(cos(0.98146845156649)
						*cos(radians(`proximity_google_latitude_0`))
						*cos(radians(`proximity_google_longitude_0`)-(-1.8247242796676))
						+sin(0.98146845156649)*sin(radians(`proximity_google_latitude_0`))))*1,3)
						ASxius_proximity_distanceWHEREROUND((3959*acos(cos(0.42296309092831)
						*cos(radians(`proximity_google_latitude_0`))
						*cos(radians(`proximity_google_longitude_0`)-(1.3011255040693))
						+sin(0.42296309092831)*sin(radians(`proximity_google_latitude_0`))))*1,3)<=200ANDROUND((3959*acos(cos(0.98146845156649)*cos(radians(`proximity_google_latitude_0`))
						*cos(radians(`proximity_google_longitude_0`)-(-1.8247242796676))+sin(0.98146845156649)*sin(radians(`proximity_google_latitude_0`))))*1,3)<=456";
