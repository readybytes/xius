...
class XiusPluginBaseTest extends XiUnitTestCase
{
	...
	public static function searchProvider()
	{
		...
		$html1 ='<inputtype="hidden"name="xiusinfo_11"id="xiusinfo_11"value="1"/>
				 <selectid="field2"name="field2"class="selectrequiredjomTipstipRight"title="Gender::Selectgender">
				 <optionvalue=""selected="selected">Selectbelow</option><optionvalue="Male">Male</option>
				 <optionvalue="Female">Female</option>'
				 ."<scripttype='text/javascript'>varslt=document.getElementById('field2');if(slt!=null){slt.options[0].selected=true;}</script>"
				 .'</select><spanid="errfield2msg"style="display:none;">&nbsp;</span>
				 <inputtype="hidden"name="xiusinfo_12"id="xiusinfo_12"value="1"/>';
		...
		$html7 = '<inputtype="hidden"name="xiusinfo_71"id="xiusinfo_71"value="7"/>
				 <divclass="jomTipstipRight"style="display:inline-block;"title="Checkbox1::Checkbox1"><labelclass="lblradio-block">
				 <inputtype="checkbox"name="field17[]"value="Checkbox1"class="checkboxjomTipstipRight"style="margin:05px5px0;"/>Checkbox1</label>
				 <labelclass="lblradio-block">
				 <inputtype="checkbox"name="field17[]"value="Checkbox11"class="checkboxjomTipstipRight"style="margin:05px5px0;"/>Checkbox11</label>
				 <labelclass="lblradio-block">
				 <inputtype="checkbox"name="field17[]"value="Checkbox2"class="checkboxjomTipstipRight"style="margin:05px5px0;"/>Checkbox2</label>
				 <labelclass="lblradio-block">
				 <inputtype="checkbox"name="field17[]"value="Checkbox21"class="checkboxjomTipstipRight"style="margin:05px5px0;"/>Checkbox21</label>
				 <labelclass="lblradio-block">
