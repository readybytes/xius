...
class XiusGroupMemberTest extends XiUnitTestCase {
	...
	function searchCondition() {
	  ...
	  // 	$post2[] = Array('infoid'=>	5,'value'=>"05-08-2011",'operator' => '=');
		...
		$resultQuery2 = "SELECT*,ROUND((3959*acos(cos(0.44237553298691)
						*cos(radians(`jsuserlatitude_0`))*cos(radians(`jsuserlongitude_0`)
						-(1.3026506251295))+sin(0.44237553298691)*sin(radians
						(`jsuserlatitude_0`))))*1,3)ASxius_proximity_distanceFROM
						`#__xius_cache`WHERE`jsfields2_0`='Male'AND`userid`
						IN(SELECT`memberid`FROM`#__community_groups_members
						`WHERE`groupid`=16)ANDROUND((3959*acos(cos(0.44237553298691)
						*cos(radians(`jsuserlatitude_0`))*cos(radians
						(`jsuserlongitude_0`)-(1.3026506251295))+sin(0.44237553298691)
						*sin(radians(`jsuserlatitude_0`))))*1,3)<=100AND`rangesearch5_0`BETWEEN'0'AND'25'ORDERBY`userid`ASC";
