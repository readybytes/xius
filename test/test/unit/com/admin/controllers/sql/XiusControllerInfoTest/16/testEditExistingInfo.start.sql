...
(1, 'Gender', 'isSearchable=1\nisVisible=1\nisSortable=1\nisExportable=1', '2', '', 'Jsfields', 1, 1),
(2, 'City', 'isSearchable=1\nisVisible=1\nisSortable=1\nisExportable=1', '11', '', 'Jsfields', 2, 1),
(3, 'Country', 'isSearchable=1\nisVisible=1\nisSortable=1\nisExportable=1', '12', '', 'Jsfields', 3, 1),
(4, 'Register Date', 'isSearchable=1\nisVisible=1\nisSortable=1\nisExportable=1', 'registerDate', '', 'Joomla', 4, 1),
(5, 'Username', 'isSearchable=1\nisVisible=0\nisSortable=1\nisExportable=1', 'username', '', 'Joomla', 5, 1),
(6, 'Name', 'isSearchable=1\nisVisible=1\nisSortable=1\nisExportable=1', 'name', '', 'Joomla', 6, 1),
(7, 'Checkbox1', 'isSearchable=1\nisVisible=0\nisSortable=0\nisExportable=1', '17', '', 'Jsfields', 7, 1),
(8, 'Birthday', 'isSearchable=1\nisVisible=1\nisSortable=1\nisExportable=1', '3', '', 'Jsfields', 8, 1);;


INSERT INTO `au_#__xius_info` (`id`,`labelName` , `params`, `key`,`pluginParams`,`pluginType`,`ordering`,`published`) VALUES
(1, 'All Gender', 'isSearchable=1\nisVisible=0\nisSortable=1\nisExportable=0', '2', '', 'Jsfields', 1, 1),
(2, 'All City', 'isSearchable=1\nisVisible=1\nisSortable=1\nisExportable=0', '11', '', 'Jsfields', 2, 0),
(3, 'Country', 'isSearchable=1\nisVisible=1\nisSortable=1\nisExportable=1', '12', '', 'Jsfields', 3, 1),
(4, 'Registeration Date', 'isSearchable=1\nisVisible=1\nisSortable=1\nisExportable=1', 'registerDate', '', 'Joomla', 4, 1),
(5, 'Username', 'isSearchable=1\nisVisible=0\nisSortable=1\nisExportable=1', 'username', '', 'Joomla', 5, 1),
(6, 'Name', 'isSearchable=1\nisVisible=1\nisSortable=1\nisExportable=1', 'name', '', 'Joomla', 6, 1),
(7, 'Checkbox1', 'isSearchable=1\nisVisible=0\nisSortable=0\nisExportable=1', '17', '', 'Jsfields', 7, 1),
(8, 'Birthday', 'isSearchable=1\nisVisible=1\nisSortable=1\nisExportable=1', '3', '', 'Jsfields', 8, 1);;
