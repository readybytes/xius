DROP TABLE IF EXISTS `bak_#__modules`;;
CREATE TABLE `bak_#__modules` SELECT * FROM `#__modules`;;
...
(44, 'XiusListing', '', 14, 'left', 62, '2010-07-03 08:40:12', 0, 'mod_xiuslisting', 0, 0, 1, '', 0, 0, ''),
(45, 'Xius Search Panel', '', 0, 'left', 0, '0000-00-00 00:00:00', 1, 'mod_xiussearchpanel', 0, 0, 1, 'xius_info_range=All\nxius_layout=vertical\n\n', 0, 0, ''),
(46, 'Search Panel 2', '', 3, 'footer', 0, '0000-00-00 00:00:00', 1, 'mod_xiussearchpanel', 0, 0, 1, 'xius_info_range=All\nxius_layout=horizontal\n\n', 0, 0, '');;

DROP TABLE IF EXISTS `bak_#__modules_menu`;;
CREATE TABLE `bak_#__modules_menu` SELECT * FROM `#__modules_menu`;;
